...
// filterResources determines whether the given object should be processed based on the cluster's config map sync configuration.
// No error is returned; false indicates the resource should not be processed.
